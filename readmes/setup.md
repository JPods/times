...
**Interaction:**
- Click a CP → select its parent structure (gold ring appears)
- Click a CP on a second structure → connect the **closest open CPs** between the two structures (two guideways drawn). It doesn't matter which specific CP you click — the system finds the nearest available pair.
- Shift+click a connected CP → disconnect
