...
# __main__.py lives inside the mesh_mobility package.
# When run as   python -m mesh_mobility   the package parent is already on sys.path.
# When run as   python mesh_mobility/__main__.py  we add the parent manually.
